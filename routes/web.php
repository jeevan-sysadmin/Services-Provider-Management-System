...
Route::post('booking-status-update',[ BookingController::class,'updateStatus'])->name('bookingStatus.update');
Route::post('/booking/update-status', 'BookingController@updateStatus')->name('booking.updateStatus');
Route::put('/payment/{id}/update-status', 'PaymentController@updateStatus')->name('payment.update-status');

Route::put('/payments/{id}/update-status', [PaymentController::class, 'updateStatus'])->name('payments.update_status');
